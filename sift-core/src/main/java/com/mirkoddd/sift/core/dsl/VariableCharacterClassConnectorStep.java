...
/**
 * An intersection step for character classes that are also variable in length.
 * <p>
 * This interface bridges two distinct rule sets in the Sift DSL. It safely exposes both
 * character class modifiers (like {@code including()}) and possessive quantifiers
