...
* **Tooling:** We use **JUnit 5** (`org.junit.jupiter`) for unit testing and **JaCoCo** for coverage reports. Please ensure all new tests are written using the JUnit 5 API.
