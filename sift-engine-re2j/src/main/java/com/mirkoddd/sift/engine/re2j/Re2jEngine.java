...
public final class Re2jEngine extends AbstractSiftEngine {
    ...
    static {
        ...
        UNSUPPORTED.put(RegexFeature.END_BEFORE_NEWLINE_ANCHOR, "RE2J Engine does not support the \\Z anchor (End before optional newline). Use andNothingElseAbsolutely() (\\z) for strict end-of-string validation instead.");
    }
